                                                ...
                                                <div class="mediaFileList">
                                                        ...
                                                        @if ($lodging->images)
                                                                ...
                                                                @foreach ($lodging->images as $key => $item)
                                                                    <li> <img
                                                                            src="{{ asset('backend/admin/images/lodging_rental/vclasss/' . $lodging->images[$key]) }}" /><button type="button" class="rm-img-btn" ><span aria-hidden="true">×</span></button>
                                ...
                                <div class="card card-flush">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-6">
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label form">Availability From</label>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label form">Availability To</label>
                                            ...
                                            <div class="col-md-2">
                                                <label class="form-label form">Cabin Capacity</label>
                                            ...
                                            <div class="col-md-2">
                                                <label class="form-label form">Cabin Type</label>
